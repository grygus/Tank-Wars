...
namespace TanksOnAHeightmap.Helpers.Drawing
{
    public class BoundingSphere3D
    {
        ...
        private void InitializeLineStrip()
        {
            ...
            _indexBuffer = new IndexBuffer(graphicsDevice,IndexElementSize.SixteenBits,  lineStripIndices.Length,
                BufferUsage.None);
        ...
        public void DrawCircle(BoundingSphere bs, Color color, Matrix? World = null)
        {
            ...
            if (bs != null)
            {
                ...
                {
                    translateMat = Matrix.CreateTranslation(bs.Center);
                }
        ...
        public void Draw(BoundingSphere bs, Color color, Matrix? World = null)
        {
            ...
            if (bs != null)
            {
                ...
                basicEffect.EnableDefaultLighting();
                //basicEffect.View = Renderer.camera.View;
                //basicEffect.Projection = mxProjectionMatrix;
