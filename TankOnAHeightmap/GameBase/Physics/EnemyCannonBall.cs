...
namespace TanksOnAHeightmap
{
    ...
    public class EnemyCannonBall
    {
        ...
        /// </summary>
        public EnemyCannonBall()
        {
            body = new Sphere(new Vector3(0, 0, 0), 25, 15);
            body.Tag = this;
        ...
        public static class Factory
        {
            ...
            /// </summary>
            private static readonly ResourcePool<EnemyCannonBall> CannonBallPool = new UnsafeResourcePool<EnemyCannonBall>(100);
            ...
            /// </summary>
            public static void GiveBack(EnemyCannonBall cannonBall)
            {
                cannonBall.Destroy();
        ...
        /// </summary>
        public static CollisionGroup EnemyCannonBallCollisionGroup { get; set; }
        ...
        /// </summary>
        public EnemyCannonBallManager Manager { get; private set; }
